...
<a href="{headquarters}">Тук</a> можеш да видиш за това кога си присъствал и забележки, които сме писали за теб.
<br>
В <a href="http://lubo.elsys-bg.org/c-programming/">сайта на Любо</a> има обща информация за курса и всичко свързано с ТУЕС.
<br><br><br>
Поздрави"""
